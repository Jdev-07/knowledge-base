...
| Product                          | Purpose                                                      |
| -------------------------------- | ------------------------------------------------------------ |
| **Entra ID** (formerly Azure AD) | Identity & access management for users, apps, and devices    |
| **Entra ID Protection**          | Detects and mitigates identity-based risks                   |
| **Entra ID Governance**          | Automates access lifecycle and entitlement reviews           |
| **Entra Verified ID**            | Issues and verifies decentralized credentials                |
| **Entra External ID**            | Manages customer and partner identities securely             |
| **Entra Workload ID**            | Secures app and service identities across clouds             |
| **Entra Private Access**         | VPN-less secure access to private apps and resources         |
| **Entra Internet Access**        | Identity-aware secure web gateway for SaaS and internet apps |
| **Entra Domain Services**        | Managed domain services for legacy apps using LDAP/Kerberos  |
| **Security Copilot Integration** | AI-powered incident response and policy recommendations      |
