A shell is a text-based interface that lets you talk with your computer. There are different types of shells, but BASH is the most popular because it's a powerful and easy to use. 
